...
const aneis = [
  ...
  {
    id: 27,
    nome: "Anel Solitário com Safira",
    preco: 3499.99,
    imagem: "/placeholder.svg?height=400&width=400",
    categoria: "Pedras Preciosas",
  },
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl">Anéis</h1>
                <p className="max-w-[700px] text-gray-300 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Explore nossa coleção exclusiva de anéis, desde solitários de diamantes até designs contemporâneos em
                  ouro e prata.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-6">
                  ...
                  <Sheet>
                    ...
                    <SheetContent side="left">
                      <SheetHeader>
                        ...
                        <SheetDescription>Refine sua busca por anéis</SheetDescription>
                      </SheetHeader>
              ...
              <div className="md:w-3/4">
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                  {aneis.map((anel) => (
                    <div key={anel.id} className="group relative overflow-hidden rounded-lg border">
                      <Link href={`/produtos/${anel.id}`} className="absolute inset-0 z-10" />
                      <div className="relative h-[250px] w-full overflow-hidden">
                        <Image
                          src={anel.imagem || "/placeholder.svg"}
                          alt={anel.nome}
                          fill
                      ...
                      <div className="p-4">
                        <h3 className="text-lg font-bold">{anel.nome}</h3>
                        <p className="text-sm text-gray-500">{anel.categoria}</p>
                        <p className="text-sm font-medium text-primary mt-1">
                          {anel.preco.toLocaleString("pt-BR", {
                            style: "currency",
                            currency: "BRL",
                          })}
                        </p>
