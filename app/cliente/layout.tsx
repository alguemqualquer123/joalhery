...
import { CreditCard, Diamond, Heart, LogOut, Menu, ShoppingBag, User } from "lucide-react"
...
export default function ClienteLayout({
  ...
  const routes = [
    ...
    },
    {
      ...
      label: "Meus Pedidos",
      icon: ShoppingBag,
      active: pathname === "/cliente/pedidos",
    },
    {
      href: "/cliente/favoritos",
      label: "Favoritos",
      icon: Heart,
      active: pathname === "/cliente/favoritos",
    },
    {
      href: "/cliente/pagamentos",
      label: "Métodos de Pagamento",
      icon: CreditCard,
      active: pathname === "/cliente/pagamentos",
    },
  ]
